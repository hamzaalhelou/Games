...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link href="{{ asset('assets/assets/css/user.css') }}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <section class="py-0">
        <div class="bg-holder" style="background-image:url({{ asset('assets/assets/img/illustrations/bg.png') }});background-position:left center;background-size:auto 816px;">
        </div>
        <!--/.bg-holder-->
      ...
      <section id="products">
        <div class="bg-holder d-none d-md-block" style="background-image:url({{ asset('assets/assets/img/illustrations/bg-car-insurance.png') }});background-position:0 200px;background-size:100% 45%;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder d-none d-md-block" style="background-image:url({{ asset('assets/assets/img/illustrations/bg-left.png') }});background-position:left;background-size:15% 100%;">
        </div>
        <!--/.bg-holder-->

        <div class="bg-holder d-none d-xl-block  mt-11" style="background-image:url({{ asset('assets/assets/img/illustrations/circle.png') }});background-position:18% 49%;;background-size:auto;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container-lg">
                ...
                <div class="tab-content w-100" id="nav-tabContent">
                  <div class="tab-pane fade show active" id="nav-car" role="tabpanel" aria-labelledby="nav-car-tab">
                    <div class="row align-items-center offset-sm-1 g-3">
                      ...
                      <div class="col-md-6 col-xl-8 text-end">
                        <div class="img-shape"><img class="feature-img" src="{{ asset('assets/assets/img/gallery/car.png') }}" alt="..." /></div>
                      </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="row align-items-center offset-sm-1 g-3">
                      ...
                      <div class="col-md-6 col-xl-8 text-end">
                        <div class="img-shape"><img class="feature-img" src="{{ asset('assets/assets/img/gallery/home.png') }}" alt="..." /></div>
                      </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="nav-paw" role="tabpanel" aria-labelledby="nav-paw-tab">
                    <div class="row align-items-center offset-sm-1 g-3">
                      ...
                      <div class="col-md-6 col-xl-8 text-end">
                        <div class="img-shape"><img class="feature-img" src="{{ asset('assets/assets/img/gallery/pets.png') }}" alt="..." /></div>
                      </div>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="nav-plane" role="tabpanel" aria-labelledby="nav-plane-tab">
                    <div class="row align-items-center offset-sm-1 g-3">
                      ...
                      <div class="col-md-6 col-xl-8 text-end">
                        <div class="img-shape"><img class="feature-img" src="{{ asset('assets/assets/img/gallery/travel.png') }}" alt="..." /></div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row offset-xl-2">
            <div class="col-12">
              ...
              <div class="row">
                <div class="col-sm-6 col-lg-3 mb-6 text-center text-sm-start"><img class="shadow-icon" src="{{ asset('assets/assets/img/icons/support.png') }}" height="60" alt="..." />
                  <h4 class="mt-4 fw-normal text-200">24x7 Support</h4>
                  <p class="text-400 mb-md-0">Client is our most <br> important priority</p>
                </div>
                <div class="col-sm-6 col-lg-3 mb-6 text-center text-sm-start"><img class="shadow-icon" src="{{ asset('assets/assets/img/icons/edit.png') }}" height="60" alt="..." />
                  <h4 class="mt-4 fw-normal text-200">Easy Claim System</h4>
                  <p class="text-400 mb-md-0">Express your desires <br>and needs to us</p>
                </div>
                <div class="col-sm-6 col-lg-3 mb-6 text-center text-sm-start"><img class="shadow-icon" src="{{ asset('assets/assets/img/icons/money.png') }}" height="60" alt="..." />
                ...
                <div class="col-sm-6 col-lg-3 mb-6 text-center text-sm-start"><img class="shadow-icon" src="{{ asset('assets/assets/img/icons/security.png') }}" height="60" alt="..." />
                          ...
                          <div class="card-body pt-0 p-md-0">
                            <div class="d-flex flex-column flex-md-row align-items-center">
                              <div class="card-span-img">
                                <div class="circle-wrapper"><img class="rounded-circle w-100" src="{{ asset('assets/assets/img/team/1.jpg') }}" alt="" /></div>
                              </div>
                      ...
                      <div class="col-12">
                        <div class="card testimonial-bg card-span text-white mt-10 mt-md-7 mt-lg-8 mx-4 mx-md-0">
                          <div class="card-body pt-0 p-md-0">
                            <div class="d-flex flex-column flex-md-row align-items-center">
                              <div class="card-span-img">
                                <div class="circle-wrapper"><img class="rounded-circle w-100" src="{{ asset('assets/assets/img/team/2.jpg') }}" alt="" /></div>
                              </div>
                              <div class="mt-n6 mt-md-0 text-center text-md-start px-md-6 px-xl-8 px-xxl-10">
                      ...
                      <div class="col-12">
                        <div class="card testimonial-bg card-span text-white mt-10 mt-md-7 mt-lg-8 mx-4 mx-md-0">
                          <div class="card-body pt-0 p-md-0">
                            <div class="d-flex flex-column flex-md-row align-items-center">
                              <div class="card-span-img">
                                <div class="circle-wrapper"><img class="rounded-circle w-100" src="{{ asset('assets/assets/img/team/3.jpg') }}" alt="" /></div>
                              </div>
                              <div class="mt-n6 mt-md-0 text-center text-md-start px-md-6 px-xl-8 px-xxl-10">
                                <h4 class="mb-0 fw-medium text-white">Charlize Theron</h4>
                                <p class="fw-normal mb-0 text-primary">Founder Circle</p>
      ...
      <section class="py-0">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-xl-between">
            ...
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('assets/assets/img/gallery/partner-1.png') }}" height="40" alt="Partner" /></div>
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('assets/assets/img/gallery/partner-2.png') }}" height="40" alt="Partner" /></div>
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('assets/assets/img/gallery/partner-3.png') }}" height="40" alt="Partner" /></div>
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('assets/assets/img/gallery/partner-4.png') }}" height="40" alt="Partner" /></div>
            <div class="col-auto col-md-4 col-lg-auto my-3 text-xl-start"><img src="{{ asset('assets/assets/img/gallery/partner-5.png') }}" height="40" alt="Partner" /></div>
          </div>
        </div>
        <!-- end of .container-->
